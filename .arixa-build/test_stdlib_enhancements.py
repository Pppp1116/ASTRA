...
def __sqrt_impl(x):
    ...
    _fn = getattr(_lib, '__sqrt_impl')
    _fn.restype = ctypes.c_double
    _fn.argtypes = [ctypes.c_double]
    return _fn(x)

def __pow_impl(x, y):
    _lib = _astra_load_first_lib(['c'])
    _fn = getattr(_lib, '__pow_impl')
    _fn.restype = ctypes.c_double
